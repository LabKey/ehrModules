...
ALTER TABLE ehr_billing.invoicedItems ALTER COLUMN invoiceNumber nvarchar(1000);
GO

ALTER TABLE ehr_billing.invoice ALTER COLUMN invoiceNumber nvarchar(1000) NOT NULL;
GO
