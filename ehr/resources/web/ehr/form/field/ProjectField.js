...
Ext4.define('EHR.form.field.ProjectField', {
    ...
    getInnerTpl: function(){
        return ['<span style="white-space:nowrap;">{[values["displayName"] + (values["investigatorId/lastName"] ? " (" + values["investigatorId/lastName"] : "") + (values["account"] ? " : " + values["account"] : "") + (values["investigatorId/lastName"] ? ")" : "")]}&nbsp;</span>'];
    },
