...
select
id, date, enddate, project, restraint, restraint.code as restraintCode, restraintTime, remark, taskid, taskid.formtype
...
select
id, date, enddate, project, null as restraint, code as restraintCode, null as restraintTime, taskid, taskid.formtype
from study."Drug Administration" b
