...
convert(T4.Total, INTEGER) as ActiveAssignments,
convert(T2.Total, INTEGER) as PendingAssignments,
convert(T1.Total, INTEGER) as ActiveResearchAssignments,
convert(T3.Total, INTEGER) as ActiveVetAssignments,
convert(T10.Total, INTEGER) as ActiveTrainingAssignments,
convert(T9.Total, INTEGER) as ActiveBreedingAssignments,
