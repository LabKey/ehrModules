...
function setDescription(row, errors){
    ...
    description.push('Start Date: ' + (row.Date ? EHR.validation.dateTimeString(row.Date) : ''));
    description.push('End Date: ' + (row.EndDate ? EHR.validation.dateTimeString(row.EndDate) : ''));
