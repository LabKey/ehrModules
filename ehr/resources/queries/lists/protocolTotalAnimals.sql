...
SELECT
  ...
  group_concat(distinct a.TotalAssignments) AS ActiveAnimals,
...
LEFT JOIN
  ...
  as LatestEnd FROM study.assignment a WHERE a.enddate is null GROUP BY a.project.protocol, a.id) a
