...
//        assertNoErrorText();
    ...
    public void animalHistoryTest()
    {
        ...
        Ext4FieldRef.waitForComponent(this, "Center Project");
        ...
        waitAndClick(Locator.linkContainingText("[Search By Project/Protocol]"));
        waitForElement(Ext4Helper.Locators.window("Search By Project/Protocol"));
        Ext4FieldRef.waitForComponent(this, "IACUC Protocol");
    ...
    public void dataRegionButtonsTest()
    {
        ...
        assertEquals("Incorrect value returned", PROTOCOL_MEMBER_IDS[0]+"\n"+PROTOCOL_MEMBER_IDS[2], _ext4Helper.queryOne("#distinctValues", Ext4FieldRef.class).getValue());
        btn = _ext4Helper.queryOne("button[text='Close']", Ext4CmpRef.class);
        waitAndClick(Locator.id(btn.getId()));
        ...
        waitAndClick(Locator.id(btn.getId()));
        waitForElement(Ext4Helper.Locators.window("Distinct Values"));
        String value = (String)_ext4Helper.queryOne("#distinctValues", Ext4FieldRef.class).getValue();
