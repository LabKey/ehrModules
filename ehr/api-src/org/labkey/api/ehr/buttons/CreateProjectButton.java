...
public class CreateProjectButton extends SimpleButtonConfigFactory
{
    ...
    {
        super(owner, "Create Project For Protocol", "EHR.window.CreateProjectWindow.buttonHandler(dataRegionName);");

        setClientDependencies(ClientDependency.supplierFromPath("ehr/window/CreateProjectWindow.js"));
    }
